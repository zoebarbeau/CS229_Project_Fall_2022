...
from features.feature_BUMP_extended import *
from features.feature_CNDV_extended import *
from features.feature_DUCT_extended import *
from features.feature_PHIL_extended import *
...
all_case.to_pickle('data/RANS_Dict_ext/all_DICT.pkl')
...
## ------------------------------------------------------------------------  ##
    ...
    if case.split('_')[0] == 'DUCT':
        RANS = feature_DUCT_extended(RANS,1,all_case[case][1])
    elif case.split('_')[0] == 'PHLL':
        RANS = feature_PHIL_extended(RANS,1,all_case[case][1])
    elif case.split('_')[0] == 'BUMP':
        RANS = feature_BUMP_extended(RANS,1,all_case[case][1])
    else:
        RANS = feature_CNDV_extended(RANS,1,all_case[case][1])
...
## ------------------------------------------------------------------------  ##
    " Save Dictionary"
    RANS.to_pickle('data/RANS_Dict_ext/'+filename+'DICT.pkl')
